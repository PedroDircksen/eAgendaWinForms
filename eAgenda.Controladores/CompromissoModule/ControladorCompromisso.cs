    ...
    public class ControladorCompromisso : Controlador<Compromisso>
    {
        ...
        public override string InserirNovo(Compromisso registro)
        {
            ...
            if (resultadoValidacao == "ESTA_VALIDO")
            {
                ...
                if (horarioOcupado)
                    resultadoValidacao = "Nesta data e horário já existe um compromisso";
                else
        ...
        private bool VerificarHorarioOcupado(DateTime data, TimeSpan horaInicio, TimeSpan horaTermino)
        {
